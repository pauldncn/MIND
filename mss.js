	...
	var slides = [
		//Loading slide seems useless
		//Blank slide to make indices make sense
		...
		[.29+2*.136,.385],[.293,.385+.182],[.293+.136,.385+.182],[.293+.136,.383+2*.182],
		[.29+2*.136,.383+2*.182]],[.136,.182]],
		['slide38',false,[['link',.87,.85,.10,.10,29]],true,2,10,[[.289,.389],
		[.284+2*.139,.389],[.289,.389+.186],[.286+.139,.389+.186],[.289,.386+2*.186],
		[.284+2*.139,.386+2*.186]],[.139,.186]],
